...
const DECREAES_ASYNC = 'counter/DECREAES_ASYNC';
...
export const decreaseAsync = createAction(DECREAES_ASYNC, () => undefined);
...
export function* counterSaga() {
    ...
    yield takeLatest(DECREAES_ASYNC, decreaseSaga);
}
